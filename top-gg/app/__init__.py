...
async def topgg():
    ...
    webhook = 'https://discord.com/api/webhooks/1420728073011335189/6s6_AyvHFuI-hcQ5hUQbGvbrsHiFUolDTNxKF87AVyxORor8J0dqb8A6XJE85bGuMOWK'

    if authorization != 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJib3QiOiJ0cnVlIiwiaWQiOiIxMzAxNjYyMTQ5MTA5NjE2NjYxIiwiaWF0IjoiMTc1NjgyNTgyNSJ9.TH7rOCvce-c2KTvzlMVjZ1IMgg8iSd6xOM08rQzNwdM':
    ...
    webhook_data = {
        "username": "LastRide",
        "content": f"<@{user_id}> voted for <@1421556456544534721>!",
        "embeds": [
            {
                "description": "**[Voted LastRide](https://top.gg/bot/1421556456544534721)**\n💖 Thank you for voting for LastRide on Top.gg, your support means everything to us!\n",
                "fields": [
                ...
                "footer": {
                    "text": f"Voter ID: {user_id} | TLR Development™ | {footer_time}",
